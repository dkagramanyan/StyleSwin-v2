#!/usr/bin/env bash
# StyleSwin -- generate 1024x1024 samples per class into the merged <desc>.h5 the wc_cv angle pipeline consumes.
#
...
# name overridable via CUDA_MODULE); H200 (sm_90) arch by default.
