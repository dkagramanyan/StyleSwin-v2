#!/bin/bash
# Generate 1024px samples (hdf5, angle-pipeline input). Set NETWORK=<snapshot-inference.pt>.
# Workstation: `NETWORK=... bash sh/generate_1024.sh`; cluster: add SLURM options at submit.
set -euo pipefail
